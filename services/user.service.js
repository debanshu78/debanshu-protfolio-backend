...
export const getUserById = async (id) => {
  // Populate only the last testimonial (if any)
...
export const removeTestimonialFromUser = async (userId, testimonialId) => {
  return await User.findByIdAndUpdate(userId, { $pull: { testimonials: testimonialId } })
}

export const updateUserWithTestimonial = async (userId, userUpdates, testimonialId) => {
